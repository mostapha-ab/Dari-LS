...
app.component('register-form-second-step',{
    ...
    <div class="second-step">
        ...
        <input type="button" class="nxt-btn" id="submit_register_btn" :disabled="btn_disabled" value="Next Step" @click="validateForm">
        <!--button class="nxt-btn" id="submit_register_btn" @click="validateForm">Submit Now</!--button-->
    </div>
    `,
    data() {
        return {
